...
public class Board implements Cloneable {
    ...
    private void removeCubeFromMap_backward() {
        if (cube.isStand()) {
    ...
    Board moveRight_backward() {
        Board board = new Board(this);
        board.removeCubeFromMap_backward();
        board.cube.moveRight();
        if (board.addCubeToMap()) {
            return board;
        }
